                ...
                <div className="flex-1">
                  {editingVideo?.uid === video.uid ? (
                    <div className="space-y-4">
                      ...
                      <input
                        type="text"
                        value={editingVideo.meta.category || ''}
                        onChange={(e) => setEditingVideo({
                          ...editingVideo,
                          meta: { ...editingVideo.meta, category: e.target.value }
                        })}
                        className="w-full px-3 py-2 bg-gray-700 rounded-lg"
                    ...
                    <>
                      ...
                      <div className="grid grid-cols-4 gap-4 text-sm">
                        ...
                        <div className="bg-gray-700 p-3 rounded-lg">
                          <div className="text-gray-400">Kategoriya</div>
                          <div className="text-lg font-semibold">{video.meta.category || '-'}</div>
                        </div>
                      </div>
                    </>
                  )}
